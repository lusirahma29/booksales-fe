...
export default function AdminBooks() {
  ...
  const [openDropdownId, setOpenDownId] = useState(null);
  ...
  const getAuthorName = (id) => {
    const author = authors.find((g) => g.id === id);
    return author ? author.name : "Unknown Author";
  };

  const toggleDropdown = (id) => {
    setOpenDownId(openDropdownId === id ? null : id)  
  }
                  ...
                  <tr key={book.id} className="border-b dark:border-gray-700">
                    ...
                    <td className="px-4 py-3 flex items-center justify-end relative">
                      ...
                      >
                        ...
                        >
                          <li>
                            <Link to={ `/admin/books/edit${book.id}`} className="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</Link>
                        ...
                        <div className="py-1">
                          <button 
                          onClick={""}
                          className="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Delete</button>
