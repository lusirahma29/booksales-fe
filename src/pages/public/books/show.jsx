            ...
            <div className="mt-6 sm:mt-8 lg:mt-0">
              ...
              <div className="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                ...
                >
                  ...
                  <button className="text-white mt-4 sm:mt-0 bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800 flex items-center justify-center">
                    Beli
                  </button>
                </form>
              </div>
